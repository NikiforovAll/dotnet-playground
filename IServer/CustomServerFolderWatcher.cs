...
{
    public class CustomServerFolderWatcher<TContext>
    {
        private readonly FileSystemWatcher watcher;
        private readonly IHttpApplication<TContext> application;
        private readonly IFeatureCollection features;
        public CustomServerFolderWatcher(IHttpApplication<TContext> application, IFeatureCollection features)
        {
        ...
        public void Watch()
        {
            watcher.Created += async (sender, e) =>
            {
                ...
                context.HttpContext = new CustomHttpContext(features, e.FullPath);
